...
<link rel="preload" href="https://kabin.life/wp-content/themes/famous_tcd064/fonts/design_plus.woff" as="font" type="font/woff2" crossorigin>
...
?>
			<<?php echo $logotag; ?> class="p-logo p-header__logo<?php if ( $dp_options['header_logo_image_retina'] ) { echo ' p-header__logo--retina'; } ?>">
				<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_attr( $image[0] ); ?>" alt="<?php bloginfo( 'name' ); ?>"<?php if ( $dp_options['header_logo_image_retina'] ) echo ' width="' . floor( $image[1] / 2 ) . '"'; ?>　class = "skip-lazy" ></a>
			</<?php echo $logotag; ?>>
<?php
	else :
?>
...
?>
			<div class="p-logo p-header__logo--mobile<?php if ( $dp_options['header_logo_image_mobile_retina'] ) echo ' p-header__logo--retina'; ?>">
				<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_attr( $image[0] ); ?>" alt="<?php bloginfo( 'name' ); ?>"<?php if ( $dp_options['header_logo_image_mobile_retina'] ) echo ' width="' . floor( $image[1]) . '"'; ?> class = "skip-lazy" ></a>
			</div>
<?php
	else :
?>
