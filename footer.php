...
?>
			<div class="p-logo p-footer__logo--mobile<?php if ( $dp_options['footer_logo_image_mobile_retina'] ) echo ' p-footer__logo--retina'; ?>">
				<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_attr( $image[0] ); ?>" alt="<?php bloginfo( 'name' ); ?>"<?php if ( $dp_options['footer_logo_image_mobile_retina'] ) echo ' width="' . floor( $image[1] / 2 ) . '"'; ?> style="height: auto !important;max-width: 50vw !important;"></a>
			</div>
<?php
else :
?>
...
if ( $dp_options['googleplus_url'] ) :
	$sns_html .= '<li class="p-social-nav__item p-social-nav__item--googleplus"><a href="' . esc_attr( $dp_options['googleplus_url'] ) . '" target="_blank"></a></li>';
endif;
...
?>
<script defer type="text/javascript">window.___gcfg = {lang: 'ja'};(function() {var po = document.createElement('script'); po.type = 'text/javascript'; po.async = true;po.src = 'https://apis.google.com/js/plusone.js';var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(po, s);})();
</script>
<?php
		endif;
...
?>
<script defer type="text/javascript">!function(d,i){if(!d.getElementById(i)){var j=d.createElement("script");j.id=i;j.src="https://widgets.getpocket.com/v1/j/btn.js?v=1";var w=d.getElementById(i);d.body.appendChild(j);}}(document,"pocket-btn-js");</script>
<?php
		endif;
		if ( $dp_options['show_pinterest_top'] || $dp_options['show_pinterest_btm'] ) :
?>
<script deferc defer src="//assets.pinterest.com/js/pinit.js"></script>
<?php
		endif;
	endif;
endif;
